...
Elm.ActionButton = Elm.ActionButton || {};
Elm.ActionButton.make = function (_elm) {
   "use strict";
   _elm.ActionButton = _elm.ActionButton || {};
   if (_elm.ActionButton.values) return _elm.ActionButton.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = function (address) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("add-button-container blue circle"),A2($Html$Events.onClick,address,{ctor: "_Tuple0"})]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("add-icon fa fa-plus")]),_U.list([]))]));
   };
   return _elm.ActionButton.values = {_op: _op,view: view};
};
Elm.AddLocationForm = Elm.AddLocationForm || {};
Elm.AddLocationForm.make = function (_elm) {
   "use strict";
   _elm.AddLocationForm = _elm.AddLocationForm || {};
   if (_elm.AddLocationForm.values) return _elm.AddLocationForm.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = A2($Html.form,
   _U.list([$Html$Attributes.id("add-location-form")]),
   _U.list([A2($Html.h1,_U.list([$Html$Attributes.$class("form-header")]),_U.list([$Html.text("New City")]))
           ,A2($Html.input,
           _U.list([$Html$Attributes.id("city-input"),$Html$Attributes.type$("text"),$Html$Attributes.placeholder("City Name")]),
           _U.list([]))]));
   return _elm.AddLocationForm.values = {_op: _op,view: view};
};
Elm.Spot = Elm.Spot || {};
Elm.Spot.make = function (_elm) {
   "use strict";
   _elm.Spot = _elm.Spot || {};
   if (_elm.Spot.values) return _elm.Spot.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("spot-container")]),
      _U.list([A2($Html.h1,_U.list([$Html$Attributes.$class("spot-name")]),_U.list([$Html.text(model.name)]))
              ,A2($Html.p,_U.list([$Html$Attributes.$class("spot-description")]),_U.list([$Html.text(model.description)]))
              ,A2($Html.p,_U.list([$Html$Attributes.$class("spot-location")]),_U.list([$Html.text(model.location)]))]));
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "UpdateDescription": return _U.update(model,{description: _p0._0});
         case "UpdateName": return _U.update(model,{name: _p0._0});
         default: return _U.update(model,{location: _p0._0});}
   });
   ...
   var Spot = F3(function (a,b,c) {    return {name: a,description: b,location: c};});
   return _elm.Spot.values = {_op: _op
                             ,Spot: Spot
...
Elm.Location.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Spot = Elm.Spot.make(_elm);
   var _op = {};
   var upVote = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("sm-circle green upvote"),A2($Html$Events.onClick,address,{ctor: "_Tuple0"})]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("upvote-icon fa fa-angle-up")]),_U.list([]))]));
   });
   var view = F2(function (address,model) {
      return A2($Html.li,
      _U.list([$Html$Attributes.$class("location-container")]),
      _U.list([A2(upVote,address,model)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("location-info-container")]),
              _U.list([A2($Html.h1,_U.list([$Html$Attributes.$class("location-name")]),_U.list([$Html.text(model.name)]))
                      ,A2($Html.div,_U.list([$Html$Attributes.$class("location-spot-breakdown")]),_U.list([$Html.text("12 bars 5 resteraunt")]))]))]));
   });
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "AddSpot": return _U.update(model,{spots: A2($List.append,model.spots,_U.list([_p0._0]))});
         case "RemoveSpot": return _U.update(model,{spots: A2($List.filter,function (spot) {    return !_U.eq(spot,_p0._0);},model.spots)});
         default: return model;}
   });
   var NoOp = {ctor: "NoOp"};
   var RemoveSpot = function (a) {    return {ctor: "RemoveSpot",_0: a};};
   var AddSpot = function (a) {    return {ctor: "AddSpot",_0: a};};
   var Location = F2(function (a,b) {    return {name: a,spots: b};});
   return _elm.Location.values = {_op: _op,Location: Location,AddSpot: AddSpot,RemoveSpot: RemoveSpot,NoOp: NoOp,update: update,view: view,upVote: upVote};
};
Elm.Locations = Elm.Locations || {};
Elm.Locations.make = function (_elm) {
   "use strict";
   _elm.Locations = _elm.Locations || {};
   if (_elm.Locations.values) return _elm.Locations.values;
   var _U = Elm.Native.Utils.make(_elm),
   $ActionButton = Elm.ActionButton.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var _op = {};
   var NoOp = {ctor: "NoOp"};
   var PromoteLocation = function (a) {    return {ctor: "PromoteLocation",_0: a};};
   var renderLocation = F2(function (address,model) {
      return A2($Location.view,A2($Signal.forwardTo,address,$Basics.always(PromoteLocation(model))),model);
   });
   var AddLocation = function (a) {    return {ctor: "AddLocation",_0: a};};
   var renderAddButton = function (address) {
      return $ActionButton.view(A2($Signal.forwardTo,address,$Basics.always(AddLocation(A2($Location.Location,"Gotham",_U.list([]))))));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.ul,
      _U.list([$Html$Attributes.$class("location-list")]),
      A2($List.append,A2($List.map,renderLocation(address),model),_U.list([renderAddButton(address)])))]));
   });
   var initialModel = _U.list([A2($Location.Location,"New York City",_U.list([]))
                              ,A2($Location.Location,"Seattle",_U.list([]))
                              ,A2($Location.Location,"Paris",_U.list([]))]);
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "AddLocation": return {ctor: "_Tuple2",_0: A2($List._op["::"],_p0._0,model),_1: $Effects.none};
         case "PromoteLocation": var _p1 = _p0._0;
           return {ctor: "_Tuple2",_0: A2($List._op["::"],_p1,A2($List.filter,function (location) {    return !_U.eq(location,_p1);},model)),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: initialModel,_1: $Effects.none};}
   });
   return _elm.Locations.values = {_op: _op
                                  ,initialModel: initialModel
                                  ,AddLocation: AddLocation
                                  ,PromoteLocation: PromoteLocation
                                  ,NoOp: NoOp
                                  ,update: update
                                  ,view: view
...
Elm.Spots = Elm.Spots || {};
Elm.Spots.make = function (_elm) {
   "use strict";
   _elm.Spots = _elm.Spots || {};
   if (_elm.Spots.values) return _elm.Spots.values;
   var _U = Elm.Native.Utils.make(_elm),
   $ActionButton = Elm.ActionButton.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var NoOp = {ctor: "NoOp"};
   var renderSpot = F2(function (address,spot) {    return A2($Spot.view,A2($Signal.forwardTo,address,$Basics.always(NoOp)),spot);});
   var AddSpot = function (a) {    return {ctor: "AddSpot",_0: a};};
   var renderAddButton = function (address) {
      var spotToAdd = A3($Spot.Spot,"The CSS Threes Cheese Lair","Yo dees dudes know a thing or 3 about cheese.","12 Union Ave. Brooklyn, N.Y. 12345");
      return $ActionButton.view(A2($Signal.forwardTo,address,$Basics.always(AddSpot(spotToAdd))));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("spots-container")]),
      A2($List.append,A2($List.map,renderSpot(address),model),_U.list([renderAddButton(address)])));
   });
   var initialModel = {ctor: "_Tuple2"
                      ,_0: _U.list([A3($Spot.Spot,"Roast Kitchen","You should go here because of dat steak","12 Union Ave. Brooklyn, N.Y. 12345")
                                   ,A3($Spot.Spot,"Milk N\' Hopts","Grab a beer and a fantastic sandwhich.","12 Union Ave. Brooklyn, N.Y. 12345")
                                   ,A3($Spot.Spot,"Joe\'s Pizza","You should go here because of dat pizza","12 Union Ave. Brooklyn, N.Y. 12345")])
                      ,_1: $Effects.none};
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "AddSpot") {
            return {ctor: "_Tuple2",_0: A2($List.append,model,_U.list([_p0._0])),_1: $Effects.none};
         } else {
            return initialModel;
         }
   });
   return _elm.Spots.values = {_op: _op
                              ,initialModel: initialModel
                              ,AddSpot: AddSpot
                              ,NoOp: NoOp
                              ,update: update
...
Elm.Main.make = function (_elm) {
   ...
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Locations = Elm.Locations.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Spots = Elm.Spots.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $Spots.initialModel,inputs: _U.list([]),view: $Spots.view,update: $Spots.update});
   var main = app.html;
   var runner = Elm.Native.Task.make(_elm).performSignal("runner",app.tasks);
   var NoOp = {ctor: "NoOp"};
   var LocationsAction = function (a) {    return {ctor: "LocationsAction",_0: a};};
   var view = F2(function (address,model) {    return A2($Locations.view,A2($Signal.forwardTo,address,LocationsAction),model.locations);});
   var initialModel = {locations: $Locations.initialModel};
   var update = F2(function (action,model) {
      var _p0 = action;
      if (_p0.ctor === "LocationsAction") {
            var _p1 = A2($Locations.update,_p0._0,model.locations);
            var updatedLocations = _p1._0;
            var fx = _p1._1;
            return {ctor: "_Tuple2",_0: _U.update(model,{locations: updatedLocations}),_1: A2($Effects.map,LocationsAction,fx)};
         } else {
            return {ctor: "_Tuple2",_0: initialModel,_1: $Effects.none};
         }
   });
   var Model = function (a) {    return {locations: a};};
